        ...
        <div className="p-6">
          <div className="space-y-4">
            ...
            <button
              ...
              className="flex cursor-pointer items-center justify-center w-full gap-3 bg-white/10 hover:bg-white/15 text-white px-4 py-3 rounded-lg transition-all border border-white/5 group"
            >
            ...
            {/* Discord Login */}
            <button
              className="flex cursor-pointer items-center justify-center w-full gap-3 bg-indigo-900/30 hover:bg-indigo-900/40 text-white px-4 py-3 rounded-lg transition-all border border-indigo-700/20 group"
            >
            ...
            {/* GitHub Login */}
            <button
              className="flex cursor-pointer items-center justify-center w-full gap-3 bg-gray-700/50 hover:bg-gray-700/70 text-white px-4 py-3 rounded-lg transition-all border border-gray-600/30 group"
            >
